...
export function recommendWorkerCount(signals) {
    ...
    else if (inputBytes >= 512 * MIB)
        workers = Math.min(workers, 2);
    else if (inputBytes >= 256 * MIB)
...
export function validateMaxInputBytes(inputBytes, maxInputBytes) {
